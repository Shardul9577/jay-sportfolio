...
const Contact = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    formData.append("access_key", "5f5b91cf-2f8e33f09");
      ...
      >
        ...
        <div className="mt-5 contact__options">
          <article className="contact__option">
            <MdEmail />
            <a href="mailto:jayustrivedi1214@gmail.com" target="_blank" className="blue-text-gradient">jayustrivedi1214@gmail.com</a>
          </article>
          <article className="contact__option">
            <BsWhatsapp />
