...
const Hero = () => {
  ...
  useEffect(()=>
  {
    init(textRef.current, { showCursor: true, strings: ['Software Developer '," Content Writer ", " Tech Enthusiast "] })
  },[]);
      ...
      >
        ...
        <div className="head2">
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hii there, I'm <p className='name text-[#915EFF]'>Jay Trivedi</p>
          </h1>
          <h3>
        ...
        <a
          href="https://github.com/Jayu1214" target="_blank">
          <AiOutlineGithub />
        </a>
        <a
          href="https://www.linkedin.com/in/jay-trivedi-work/" target="_blank">
          <ImLinkedin />
        </a>
        <a
          href="https://www.instagram.com/jay.triveedi/" target="_blank">
          <AiOutlineInstagram />
        </a>
